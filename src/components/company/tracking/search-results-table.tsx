                ...
                <TableBody>
                 {challans.map((row) => (
                    ...
                    >
                        ...
                        <TableCell className={cn(tdClass)}>{format(new Date(row.dispatchDate), 'dd-MMM-yyyy')}</TableCell>
                        ...
                        <TableCell className={cn(tdClass)}>{row.inwardDate ? format(new Date(row.inwardDate), 'dd-MMM-yyyy') : 'N/A'}</TableCell>
